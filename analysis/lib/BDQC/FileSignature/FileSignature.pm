package BDQC::FileSignature::FileSignature;
...
my $CLASS = 'BDQC::FileSignature::FileSignature';
my $DEBUG = 0;
my $VERBOSE = 0;
my $TESTONLY = 0;
...
###############################################################################
  ...
  my $FileHandle = new  IO::Uncompress::AnyUncompress $filePath;
  return $FileHandle;
